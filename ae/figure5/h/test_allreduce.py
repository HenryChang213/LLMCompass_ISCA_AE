...
if __name__ == "__main__":
    ...
    allreduce_TPUv3 = pd.read_csv(
        "ae/figure5/h/real_hardware/allreduce_TPUv3.csv",
        header=None,
        names=["size", "latency", "bandwidth"],
    )
    size_list = allreduce_TPUv3["size"].to_list()
    ...
    tpu_bandwidth_list = allreduce_TPUv3["bandwidth"].to_list()

    size_list = allreduce_TPUv3["size"].to_list()[6:]
    tpu_bandwidth_list = allreduce_TPUv3["bandwidth"].to_list()[6:]
    simulated_tpu_bandwidth_list = simulated_tpu_bandwidth_list[6:]
    plt.plot(
        size_list,
        tpu_bandwidth_list,
        marker="o",
        label="Real Google TPUv3 Node",
